...
"}")
        ...
        self.label.setStyleSheet("font: 700 30pt \"Calibri\";\n"
...
"color: rgb(243, 243, 243);")
        ...
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget, clicked= lambda: update_weather())
        ...
        self.label_3.setGeometry(QtCore.QRect(450, 140, 171, 151))
        ...
        def update_weather():
            ...
            with open(os.path.relpath("weather_data.json")) as loc_file:
                self.weather = json.load(loc_file)
            print(self.weather['latitude'])
